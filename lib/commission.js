...
// Flat commission paid to whoever hands a held Customer Item back to its
// owner. Tracked entirely separately from washing/ironing commission.
export const CUSTOMER_ITEM_CLAIM_COMMISSION = 0.5;

// Flat commission paid to whoever dispatches a Dead Stock order back to its
// customer. Tracked entirely separately from every other commission.
export const DEAD_STOCK_GIVEN_OUT_COMMISSION = 0.5;
